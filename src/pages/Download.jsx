...
function Download() {
  ...
  const descargarAPK = () => {
    ...
    window.open(
      ...
      "https://finnova-haln-co0neeanb-fin-nova.vercel.app/",
          ...
          <div className="bg-[#111111] border border-[#222] rounded-[40px] p-10 flex flex-col items-center justify-center text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="bg-white p-6 rounded-[35px] inline-block mb-10">
                ...
                <img
                  src="https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=https://finnova-haln-co0neeanb-fin-nova.vercel.app/"
                  alt="QR FinNova"
